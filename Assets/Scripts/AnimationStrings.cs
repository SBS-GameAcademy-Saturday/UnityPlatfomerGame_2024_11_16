...
public static class AnimationStrings
{
    ...
    public static string ProjectileAttackParameterName = "ProjectileAttack";
    ...
    public static int ProjectileAttack = Animator.StringToHash(ProjectileAttackParameterName);
}
